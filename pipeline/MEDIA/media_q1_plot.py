...
# -----------------------------
# ✅ Paths (fixed to reach capstone3 root)
# -----------------------------
ROOT = Path(__file__).resolve().parents[2]
RESULTS_DIR = ROOT / "results" / "media"

CSV_2020 = RESULTS_DIR / "media_q1_agents_2020.csv"
CSV_2025 = RESULTS_DIR / "media_q1_agents_2025.csv"
OUT_PNG = RESULTS_DIR / "media_q1_trend_chart.png"

# Verify existence
for f in [CSV_2020, CSV_2025]:
    if not f.exists():
        raise FileNotFoundError(f"\n❌ Missing file: {f}\nPlease verify that the media_q1_agents CSV files exist in /results/media.\n")

print(f"[INFO] ROOT: {ROOT}")
print(f"[INFO] Using files:\n  {CSV_2020}\n  {CSV_2025}\n")
...
# -----------------------------
# Plot (Pew-style trend chart)
# -----------------------------
plt.figure(figsize=(8, 5))
plt.plot(["2020", "2025"], [year_2020[0], year_2025[0]], marker="o",
         label="Right direction", color="#1B998B", linewidth=3)
plt.plot(["2020", "2025"], [year_2020[1], year_2025[1]], marker="o",
         label="Wrong direction", color="#E9C46A", linewidth=3)
plt.plot(["2020", "2025"], [year_2020[2], year_2025[2]], marker="o",
         label="No opinion", color="#A8A8A8", linewidth=3, linestyle="--")
...
plt.title("Trend in Agents’ Perception of U.S. Higher Education (2020–2025)",
