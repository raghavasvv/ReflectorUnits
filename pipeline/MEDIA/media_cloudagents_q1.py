...
# ====================================================
# ✅ PATH FIX — Ensure pipeline modules can be imported
# ====================================================
# Go two levels up: from pipeline/MEDIA → capstone3/
ROOT = Path(__file__).resolve().parents[2]
sys.path.append(str(ROOT))

# (Optional but recommended) ensure pipeline is a Python package:
# capstone3/pipeline/__init__.py should exist (even if empty)
